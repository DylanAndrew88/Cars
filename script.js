  ...
  class Car extends Factory {
    constructor(make, location, airbags, abs, model, doors, color, enginetype, transmission, trim, wheelstrim, audio, seatstrim, moonroof) {
       super({make, location, airbags, abs});
       this.model = model;
       this.doors = doors;
       this.color = color;
